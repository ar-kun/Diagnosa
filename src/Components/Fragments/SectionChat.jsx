    ...
    <>
      <section id="histori" class="[&>*]:my-2 w-[30%] h-screen flex flex-col">
        ...
        <div class="bg-gradient-to-r from-sky-500 to-secondary rounded-lg p-5 text-white">
          ...
          <p>
            Demam. Menggigil. Sakit kepala. Berkeringat banyak. Lemas. Pegal
            linu.
          </p>
        </div>
      ...
      >
        ...
        <div class="h-[70%] flex flex-col gap-5 text-white overflow-auto">
          ...
          <div class="bg-gradient-to-r from-sky-500 to-secondary p-5 rounded-lg w-[70%]">
            ...
            Anopheles yang membawa parasit Plasmodium. Untuk mendapatkan
            diagnosis yang akurat, sangat penting untuk melakukan pemeriksaan
            medis yang lebih mendalam dan tes darah yang dapat mendeteksi
            keberadaan parasit malaria.
          </div>
          <div class="bg-gradient-to-r from-sky-500 to-secondary p-5 rounded-lg w-[70%]">
            Istirahat dan Hidrasi: Jaga agar tubuh Anda tetap terhidrasi dengan
            minum air yang cukup. Istirahat yang cukup juga penting untuk
